...
class Binomial(Distribution):
    ...
    def replace_stats_with_data(self):
        ...
        self.p = 1.0 * sum(self.data) / len(self.n)
    ...
    def plot_bar(self):
        ...
        plt.bar(x=['0', '1'], height=[(1 - self.p) * self.n, self.p * self.n], color='maroon')
        plt.xlabel('Outcomes of an experiment')
    ...
    def __add__(self, other):
        ...
        bino_obj = Binomial()
        bino_obj.n = self.n + other.n
        bino_obj.p = self.p
        bino_obj.calculate_mean()
        bino_obj.calculate_stdev()
